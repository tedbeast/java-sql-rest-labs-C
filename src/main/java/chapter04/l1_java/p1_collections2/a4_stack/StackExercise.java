package chapter04.l1_java.p1_collections2.a4_stack;
...
public class StackExercise {
    ...
    /**
     * Push (this is another way of saying 'add') a value to the top of the deque.
     * While an 'add' method also exists in a Deque, this performs queue behavior and will not work.
     * @param stack A Deque of Strings.
    ...
    /**
     * Pop (this is another way of saying 'remove') the value from the top of the deque and return that value.
     * While a 'remove' method also exists in a Deque, this performs queue behavior and will not work.
     * The pop method, used to remove items from a stack, also returns the value.
     * @param stack A Deque of Strings.
    ...
    /**
     * Return the value at the top of a deque without removing the value. (This is called 'peek')
     * @param stack A Deque of Strings.
